...
class Hemdap(nn.Module):
    def __init__(self, hidden_dim, feats_dim_list1, feats_dim_list2, feat_drop, attn_drop, P1, P2, sample_rate,sample_rate1,
        ...
        model = MINIMDA(args)
        self.sc1 = model(graph, miRNA, disease)
    ...
    def forward(self, feats1, feats2, mps1, mps2, nei_index1, nei_index2, graph):  # p a s
       ...
       # z_sc2 = self.sc2(h_all2, nei_index2)
        ...
        z_sc1,  z_sc2 = self.sc1(graph, h_all1[0],h_all1[1])
    ...
    def get_embeds(self, feats1, feats2, mps1, mps2, nei_index1, nei_index2):
        ...
        # z2 = self.pca.fit_transform(z2.cpu().numpy())
        return z1, z2
